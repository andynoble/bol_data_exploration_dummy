...
for line in f:
    ...
    #BOL Header
        ...
        separators = (2,6,8,33,37,45,46,62,73,78,89,92,103,106
                      ,107,157,161,162,178,180,205,207,209,213
                      ,217,221,225,229,233,237,241,245,249,257,400)
    #Container/Equipment
    elif rec_type == '20':
        separators = (2,19,34,49,51,56,64,72,76,77,79,96,111,126
                      ,128,133,141,149,153,154,156,173,188,203,205
                      ,210,218,226,230,231,233,250,265,280,282,287
                      ,295,303,307,308,310,327,342,357,359,364,372
                      ,380,384,385,387,400)
    #Shipper
    elif rec_type == '30':
    ...
    #Cargo Description Tariff Information
        ...
        separators = (2,19,22,32,40,50,53,64,74,82,92,95,106,116,124,134
                      ,137,148,158,166,176,179,190,200,208,218,221,232
                      ,242,250,260,263,274,284,292,302,305,316,326,334
                      ,344,347,358,368,376,386,389,400)
